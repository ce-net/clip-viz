...
The mesh-transmitted visualization cell for **clip** — ambient clipboard sync across your fleet.
...
- `cecomponents.toml` — declares the component (tag `ce-viz-clip`, module `components/viz.js`).
...
- Backing surface it visualizes: `clip/sync/1`.
